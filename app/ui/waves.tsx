...
const Waves: React.FC<WavesProps> = ({
    ...
    useEffect(() => {
            ...
            lines.forEach((pts) => {
                pts.forEach((p) => {
                    ...
                    if (dist < l) {
                        ...
                        p.cursor.vx +=
                            Math.cos(mouse.a) * f * l * mouse.vs * 0.00065;
                        p.cursor.vy +=
                            Math.sin(mouse.a) * f * l * mouse.vs * 0.00065;
                    }
        ...
        function moved(
            ...
            const x =
                point.x + point.wave.x + (withCursor ? point.cursor.x : 0);
            const y =
                point.y + point.wave.y + (withCursor ? point.cursor.y : 0);
